...
function getPublishList(pageNum,startTime,endTime){
	...
	if(startTime==null||startTime==""){
	     ...
	     var endTime = myCreate.getFullYear() + "-" + DoubleOrOne(myCreate.getMonth()+1) + "-" + DoubleOrOne(myCreate.getDate())+" 00:00:00";
	}
						...
						function(data) {
							...
							for ( var i = 0; i < dataList.length; i++) {
								...
								var sysDate = myCreateDate.getFullYear()
										+ "-"
										+ DoubleOrOne(myCreateDate.getMonth() + 1)
										+ "-"
										+ DoubleOrOne(myCreateDate.getDate());
								...
								notice_list += "<td><div class=\"detail\"><a href=\"javascript:;\" onclick=\"notice_notice_detail_jsp('"
										+ dataList[i].id
										+ "');\">"
										+ tempText
										+ "</a></div></td>";
		...
		<section>
			<div class="content clearfix">
				...
				<div class="notice-right-body">
					...
					<div
						style="float: left; width: 100%; height: 50px; clear: both; text-align: center;" class="divide-page">
