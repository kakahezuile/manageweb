...
<link href="${pageContext.request.contextPath }/css/app.css?version=1.4.0" rel="stylesheet" type="text/css">
...
<script src="${pageContext.request.contextPath }/jsp/app/download-test.js?version=1.4.0"></script>
</head>
<body>
...
<!--<div class="donwload-bg"><img src="${pageContext.request.contextPath }/images/app/download.jpg"/></div>-->
	<section>
		<div class="download-content">
			...
			<div>
				<p class="tip-title">请点击下面按钮下载安装&nbsp;&nbsp;周边店家测试版APP</p>
			</div>
			<div class="download">
				<p>
					<a class="android" href="http://7d9lcl.com2.z0.glb.qiniucdn.com/bangbang_outlet_test.apk">
						<span>安卓版下载</span>
					</a>
				</p>
				<p>
