...
<body>
	<section>
		<div class="content">
			<div class="shop_help_title"><b>&nbsp;</b>被恶意投诉了该怎么办？</div>
			<div class="shop_help-item">
				<p>
					当您成为帮帮的合作商家后，您可以通过帮帮商家端对您的服务线上支付的部分进行结款。
				</p>
			</div>
			<div class="shop_help-item">
				<p>1.及时打开客服（我-帮助-客服）告知具体情况并附上您的申述原因</p>
				<p>2.立即拍照，并向客服留据</p>
				<p>3.到你所在的物业小区，帮帮物业部门，及时反映您所遇到的情况，我们将派专人前去了解查证</p>
			</div>
		</div>
	</section>
</body>
