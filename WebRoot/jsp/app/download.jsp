...
<script src="${pageContext.request.contextPath }/jsp/app/download.js?version=<%=versionNum %>"></script>
	...
	<section>
		<div class="download-content">
			...
			<div>
				...
				<p class="tip-second-title">（建议Wi-Fi环境下操作）</p>
			</div>
			<div class="download">
				<p>
					<a class="android" href="http://7d9lcl.com2.z0.glb.qiniucdn.com/bangbang_c.apk">
						<span>安卓版（10.9M）</span> 
					</a>
				</p>
				<p>
					<a class="ios" href="https://itunes.apple.com/cn/app/bang-bang-she-qu-hao-bang-shou/id978272133?mt=8">
						<span>iOS版（35.4 M）</span>
					</a>
				</p>
			</div>
		</div>
