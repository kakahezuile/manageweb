...
<script src="${pageContext.request.contextPath }/jsp/app/downloadshop.js?version=<%=versionNum %>"></script>
</head>
<body>
	<section>
		<div class="download-content">
			<div class="download-title">
				<img src="${pageContext.request.contextPath }/images/app/download-logo-shop.png"/>
			</div>
			<div>
				<p class="tip-title">请点击下面按钮下载安装APP</p>
			</div>
			<div class="download">
				<p class="other">
					<a class="android-shop" href="http://7d9lcl.com2.z0.glb.qiniucdn.com/bangbang_shop.apk" >
						<span>安卓版下载</span>
					</a>
				</p>
				<p class="other">
					<a class="ios-shop" href="https://itunes.apple.com/cn/app/bang-bang-fu-wu-bang-bang/id982495888?mt=8">
						<span>iOS版下载</span>
					</a>
				</p>
			</div>
