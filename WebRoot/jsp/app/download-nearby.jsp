...
<script src="${pageContext.request.contextPath }/jsp/app/download-nearby.js?version=<%=versionNum %>"></script>
	...
	<section>
		<div class="download-content">
			<div class="download-title">
				<img src="${pageContext.request.contextPath }/images/app/logo-nearby.png"/>
			</div>
			<div>
			...
			<div class="download">
				<p class="other">
					<a style="background:#ff8500;"  class="android" href="http://7d9lcl.com2.z0.glb.qiniucdn.com/bangbang_outlet.apk">
						<span>安卓版（14.3M）</span> 
					</a>
				</p>
				<p class="other">
