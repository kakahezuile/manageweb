...
<html class="">
	...
	<div class="upload-master-face-bg" id="upload-master-face-bg" style="display: none;">&nbsp;</div>
		...
		<section>
				...
				<div class="right-body" style="border:none;">
					<div class="push-table">
						<table id="communities_table">
							...
							<c:forEach items="${pageBean.pageData }" var="pb" varStatus="o" >
								<tr class="<c:if test="${o.index%2==0 }">odd</c:if> <c:if test="${o.index%2==1 }">even</c:if>">
								<td>${pb.time }</td>
								<td><div class="push-title" title="${pb.context }">${pb.context }</div></td>
								<td>${pb.pushNum}</td>
								<td>${pb.successNum }</td>
								<td><b class="failure"><font color="red">${pb.failNum }</font></b></td>
								<td>暂时未知</td>
								<td><a href="${pageContext.request.contextPath }/stat/PushMessage/communities/${communityId}/${pb.messageId}/notificationDetail.do?page=1&pageSize=15">详情</a></td>
							</tr>
							...
							<tr class="odd">
								...
								<td>100</td>
								<td>92</td>
								<td><b class="failure">8</b></td>
								<td>3分48秒</td>
								<td><a href="${pageContext.request.contextPath }/jsp/push/push-detail.jsp">详情</a></td>
							</tr>
							<tr class="even">
								<td>6-28 10:16:15</td>
			...
			<a href="http://localhost:8080/stat/PushMessage/communities/${communityId}/100/statNotificationPushMessage.do?page=1&pageSize=15">首页</a>
			<a href="http://localhost:8080/stat/PushMessage/communities/${communityId}/100/statNotificationPushMessage.do?page=${pageBean.prev }&pageSize=15">上一页</a>
			...
			<a href="${pageContext.request.contextPath }/stat/PushMessage/communities/${communityId}/100/statNotificationPushMessage.do?page=${pageBean.next }&pageSize=15">下一页</a>
			<a href="${pageContext.request.contextPath }/stat/PushMessage/communities/${communityId}/100/statNotificationPushMessage.do?page=${pageBean.last }&pageSize=15">尾页</a>
			</div>
