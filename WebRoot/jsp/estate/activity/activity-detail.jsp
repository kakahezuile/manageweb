	      ...
	      var path = "<%= path%>/api/v1/communities/"+communityId+"/activities/webIm/getActivitiesDetail?activitiesId="+activitiesId;
				$.ajax({
					...
					if(activityStatus=="ongoing"){
						activityPower = "<a id=\"activities_aid_"+data.activityId+"\" href=\"javascript:;\" onclick=\"deleteActivities("+data.activityId+",'"+data.emobGroupId+"')\" class=\"refuse\">关闭群组</a>";
					...
					activitesDate.empty();
					 ...
					 activitesDatail+="<p>地点：<span>  "+data.place+"</span></p></div></div>";
