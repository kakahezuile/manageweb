				...
				<form id="waterForm" method="post" enctype="multipart/form-data">
					...
					<div class="clearfix">
						...
						<div class="welfare-content">
							<select name="communityId" id="communities" onchange="javascript:waterAdd.selectFloor(this)">
					...
					<div class="clearfix">
						<div class="welfare-tag"><span>住址</span></div>
						<div class="welfare-content">
							<select name="userFloor" id="notice_special_select_floor" onchange="javascript:waterAdd.selectUnit(this);">
								<option>请选择楼</option>
							</select > 
							<select name="userUnit" id="notice_special_select_unit" onchange="javascript:waterAdd.selectRoom(this);" >
								<option>请选择单元</option>
							</select> 
							<select name="room" id="notice_special_select_room" >
								<option>请选择房间</option>
							</select>
						</div>
					</div>
					...
					<div class="welfare-submit">
						<a href="javascript:waterAdd.submit('user');">提交</a>
					</div>
				</form>
			</div>
			</div>
