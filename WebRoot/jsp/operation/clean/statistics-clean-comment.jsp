...
<![endif]-->
		...
		<script
			src="${pageContext.request.contextPath }/js/clean/statistics-clean-comment.js"></script>
	...
	<body>
		...
		<input type="hidden" id="master_repir_sort_fei" value="6" />
					...
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
								...
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-comment.jsp"
										class="select">投诉与评价</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-time.jsp">服务时间段</a>
								</li>
