...
<script src="${pageContext.request.contextPath }/js/operation.js"></script>
		...
		<script
			src="${pageContext.request.contextPath }/js/clean/statistics-clean-time.js"></script>
					...
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-dosage.jsp">使用量</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-turnover.jsp">营业额</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-comment.jsp">投诉与评价</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-time.jsp"
...
<script type="text/javascript">
	...
	<script
		src="${pageContext.request.contextPath }/js/clean/statistics-clean.js"></script>
