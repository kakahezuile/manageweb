...
<script src="${pageContext.request.contextPath }/js/clean/statistics-clean-dosage.js"></script>
</head>
<body>
			...
			<div class="right-body">
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
								<li><a href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-dosage.jsp" class="select">使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-turnover.jsp" >营业额</a></li>
