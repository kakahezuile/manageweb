...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath }/js/clean/statistics-clean-turnover.js"></script>
	...
	<body>
		...
		<input id="date_type_get" type="hidden" />
				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
								<li><a href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-dosage.jsp" >使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-turnover.jsp"  class="select">营业额</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-comment.jsp">投诉与评价</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/clean/statistics-clean-time.jsp" >服务时间段</a></li>
							</ul>
						</div>
					...
					<div class="shop-dosage-detail-box">
						...
						<div class="shop-dosage-total">
							<ul>
								...
								<li>
									<span><b>日均 交易额</b> </span><span id="avg_day_turnover">0</span>
								</li>
								<li>
									<span><b>日均线上交易额 </b> </span><span id="avg_day_order">0</span>
								</li>
								<li>
	...
	<script src="${pageContext.request.contextPath }/js/clean/statistics-clean.js"></script>
</html>
