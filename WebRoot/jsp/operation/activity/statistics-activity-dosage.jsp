...
<script src="${pageContext.request.contextPath }/js/activity/statistics-activity-dosage.js?version=<%=versionNum %>"></script>
			...
			<div class="right-body">
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/activity/statistics-activity-dosage.jsp" class="select">使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/activity/statistics-activity-active.jsp" >活跃度(待做)</a></li>
						</ul>
					</div>
