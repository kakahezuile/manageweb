...
<script src="${pageContext.request.contextPath }/js/statistics-pay-dosage.js"></script>
</head>
<body>
			...
			<div class="right-body">
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/statistics-pay-dosage.jsp?pages=<%=pages %>" class="select">使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/statistics-pay-turnover.jsp?pages=<%=pages %>" onclick="typeStatistics();">缴费金额</a></li>
