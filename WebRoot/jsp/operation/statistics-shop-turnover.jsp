...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath }/js/statistics-shop-turnover.js"></script>
				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
								<li><a href="${pageContext.request.contextPath }/jsp/operation/statistics-shop-dosage.jsp?pages=<%=pages %>" >使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/statistics-shop-turnover.jsp?pages=<%=pages %>"  class="select" onclick="typeStatistics();">营业额</a></li>
					...
					<div class="shop-dosage-detail-box">
						...
						<div class="shop-dosage-total">
							<ul>
								<li>
									<a href="javascript:;" onclick="alterMonth('1');">上一月</a>
								</li>
								<li>
								...
								<li>
									<a href="javascript:;"  onclick="alterMonth('2');">下一月</a>
								</li>
							</ul>
						</div>
	...
	<script
			src="${pageContext.request.contextPath }/js/statistics-shop.js"></script>
</html>
