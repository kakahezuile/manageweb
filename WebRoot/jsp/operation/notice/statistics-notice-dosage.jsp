...
<script src="${pageContext.request.contextPath }/js/notice/statistics-notice-dosage.js?version=<%=versionNum %>"></script>
				...
				<div class="shop-dosage-detail-box">
					...
					<div class="shop-dosage-total">
						<ul>
							...
							<li style="display: none;"><span><b>今日点击量(人数)</b> </span><span id="avg_day_turnover">450</span></li>
							<!--
...
<script src="${pageContext.request.contextPath }/js/notice/statistics_notice.js?version=<%=versionNum %>"></script>
