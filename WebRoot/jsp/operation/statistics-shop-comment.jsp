...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath }/js/statistics-shop-comment.js"></script>
				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							...
							<li><a href="${pageContext.request.contextPath }/jsp/operation/statistics-shop-comment.jsp?pages=<%=pages %>" class="select">投诉与评价</a></li>
					...
					<div class="shop-dosage-detail-box">
						<div class="shop-dosage-detail">
							...
							-->
							<a href="javascript:;" class="select" id="data_clik" onclick="quickShopData('2');timeClick('data_clik');">昨日</a>
