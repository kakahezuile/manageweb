...
<script src="${pageContext.request.contextPath }/js/pay/statistics-pay-turnover.js"></script>
</head>
<body>
       <input type="hidden" id="pay_sum"  />
			...
			<div class="right-body">
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/pay/statistics-pay-dosage.jsp" >使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/pay/statistics-pay-turnover.jsp" >缴费金额</a></li>
...
<script src="${pageContext.request.contextPath }/js/pay/statistics-pay.js"></script>
