...
<script src="${pageContext.request.contextPath }/js/pay/statistics-pay-dosage.js"></script>
</head>
<body>
			...
			<div class="right-body">
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/pay/statistics-pay-dosage.jsp" class="select">使用量</a></li>
