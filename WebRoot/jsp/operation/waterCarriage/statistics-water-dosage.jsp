...
<script src="${pageContext.request.contextPath }/js/waterCarriage/statistics-water-dosage.js?version=<%=versionNum %>"></script>
				...
				<div class="shop-dosage-box">
					...
					<!--<div class="shop-dosage-summary clearfix">
						<ul>
							...
							<li>
								<p><b id="nearby_cvs_num_test" class="green">0</b></p>
								<p><span>工作人员</span></p>
							</li>
							<li>
								<p><b id="click_bi">0</b></p>
								<p><span>点击率</span></p>
							</li>
...
<script src="${pageContext.request.contextPath }/js/waterCarriage/statistics_water.js?version=<%=versionNum %>"></script>
