...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath }/js/waterCarriage/statistics-water-time.js"></script>
	...
	<body>
	<input type="hidden" id="wei_zhi" value="4"/>
				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
									<li><a href="${pageContext.request.contextPath }/jsp/operation/waterCarriage/statistics-water-dosage.jsp" >使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/waterCarriage/statistics-water-time.jsp" class="select">服务时间段</a></li>
	...
	<script
			src="${pageContext.request.contextPath }/js/waterCarriage/statistics_water.js"></script>
