		...
		activity_Title.append("<input id=\"activity_Title"+activityId+"\" value=\""+activityTitle+"\" type=\"hidden\"/>");
		 if(status == "ongoing"){
			if(activities_sum % 2 == 0){
				...
				activitesUl.append("<tr  class=\"odd\"><td><a  href=\"<%=path %>/jsp/operation/monitoring/lifecircle-detail.jsp?activitiesId="+activityId+"\">"+activityTitleTemp+"</a></div></td><td><div title=\""+activityDetailTemp+"\" class=\"lifecircle-user\"><p>刘文静</p><p>3号楼2单元102</p></div></td><td class=\"pic\">"
			+array_element_ar+
				...
				activitesUl.append("<tr class=\"even\"><td><a  href=\"<%=path %>/jsp/operation/monitoring/lifecircle-detail.jsp?activitiesId="+activityId+"\">"+activityTitleTemp+"</a></div></td><td><div title=\""+activityDetailTemp+"\" class=\"lifecircle-user\"><p>刘文静</p><p>3号楼2单元102</p></div></td><td class=\"pic\">"
			+array_element_ar+
