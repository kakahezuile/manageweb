...
<body>
			...
			<div class="right-body">
				...
				<div class="reckoning-body" >
					<div class="sensitiveCenter">
						<div class="reckoning-content" id="MonitorComplaintsTopTable2">
							<div>正在加载中...</div>
						</div>
					</div>
				</div>
	...
	function monitorComplaintsServiceClick(){
		...
		$.ajax({
			...
			success:function(data2){
			    data=data2.info;
				var repair_overman = $("#MonitorComplaintsTopTable");
			    repair_overman.empty();
			    repair_overman.append("<tr class=\"monitoring-detail-th\" ><td>用户</td><td>用户电话</td>	<td>投诉对象</td><td>投诉内容</td><td>处理客服</td></tr>");
			    repair_overman.append("<tr class=\"monitoring-detail-th\" ><td>"+data.userName+"</td><td>"+data.phone+"</td>	<td>"+data.shopName+"</td><td>"+data.detail+"</td><td>"+data.nickname+"</td></tr>");
	...
	function isTo(type){
	  ...
	  getMessageListFromUser3("<%=from%>","c84258e9c39059a89ab77d846ddab909");
	   ...
	   getMessageListFromUser3("<%=from%>","<%=to%>");
	  }
