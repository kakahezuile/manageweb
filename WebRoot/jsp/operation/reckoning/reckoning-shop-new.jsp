			...
			<div class="content clearfix">
				...
				<div class="right-body">
					<div class="reckoning-title">
						<span>永发超市</span>
						<span>（银行卡:200360012554874）</span>
						<a class="reckoning-title-a" href="${pageContext.request.contextPath }/jsp/operation/reckoning/reckoning-history-new.jsp?sort=<%=sort %>">结款历史</a>
					</div>
					<div class="cash-title">
						<p class="cash-finish">
							<span>结款金额：</span>
							<span class="cash-number">0.00</span>
							<a href="javascrit:void(0);">结款</a>
						</p>
						<div id="top_section_time" class="time-chose-search">
							<input value="请选择开始日期" id="txtBeginDate" readonly="readOnly">
							<input value="请选择结束日期" id="txtEndDate" readonly="readOnly">
							<a onclick="selectStatistics();" href="javascript:void(0);">查询</a>
						</div>
					</div>
					<div class="reckoning-body">
						<table id="reckonign_shop">
							...
							<tr>
								...
								<td>48.00</td>
								<td>3.00</td>
								<td><a href="${pageContext.request.contextPath }/jsp/operation/reckoning/reckoning-deduct-new.jsp?emobId=1fb83f5875c78af4992fe83771ab4c2e" class="withhold">扣款</a></td>
								<td>0.00</td>
								<td>24.00</td>
								<td>未结</td>
							</tr>
							<tr>
								...
								<td>48.00</td>
								<td>3.00</td>
								<td><a href="${pageContext.request.contextPath }/jsp/operation/reckoning/reckoning-deduct-new.jsp?emobId=1fb83f5875c78af4992fe83771ab4c2e" class="withhold2">已扣款</a></td>
								<td>1.00</td>
								<td>23.00</td>
								<td>未结</td>
							</tr>
