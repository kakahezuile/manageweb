		...
		<div class="content clearfix">
			...
			<div class="right-body">
				<div class="reckoning-title">
					<span>结款历史</span>
					<span>（永发超市）</span>
					<div id="top_section_time" class="time-chose-search" style="top:0;">
						<span>结款总额：</span>
						<span>20.00</span>
				...
				<div class="reckoning-body">
					<table id="reckonign_history1">
						...
						<tr class="odd">
							...
							<td>0</td>
							<td>82</td>
							<td><a href="${pageContext.request.contextPath }/jsp/operation/reckoning/reckoning-record-new.jsp">详单</a></td>
						</tr>
						<tr  class="even">
							<td>2015-07-02 10:11</td>
							<td>3</td>
			...
			for ( var i = 0; i < data.length; i++) {
	          ...
	          //  var j=getMonthWeek(yes,month,day);
				...
				// list+="<td>"+data[i].deductionShopNum+"</td>";
				 ...
				 list+="<td><a href=\"${pageContext.request.contextPath }/jsp/operation/reckoning/reckoning-record-new.jsp?sort=2&startTime="+data[i].startTime+"&endTime="+data[i].endTime+"\">详单</a></td></tr>";
