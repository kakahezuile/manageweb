				...
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							...
							<li><a href="${pageContext.request.contextPath }/jsp/operation/nearby/statistics-nearby-community.jsp" class="select" >小区统计</a></li>
						</ul>
					</div>
					<div class="statistics-public clearfix">
						...
						<div class="divide-page" style="float:left;width:100%;height:50px;clear:both;text-align:center;">
							...
							<a href="javascript:void(0);" onclick="nearby.community(-3);">首页</a>
							<a href="javascript:void(0);" onclick="nearby.community(-1);">上一页</a>
							当前第 <font id="pageNumText">1</font> 页
							共 <font id="pageCountText"></font> 页
							共 <font id="totalText"></font> 条
							<a href="javascript:void(0);" onclick="nearby.community(-2);">下一页</a>
							<a href="javascript:void(0);" onclick="nearby.community(-4);">尾页</a>
						</div>
					</div>
				</div>
			</div>
