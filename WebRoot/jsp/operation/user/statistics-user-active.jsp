			...
			<div class="shop-dosage-box">
				<div class="shop-dosage">
					<ul>
						...
						<li><a href="${pageContext.request.contextPath }/jsp/operation/user/statistics-user-active.jsp" class="select">活跃用户数</a></li>
				...
				<div class="statistics-public clearfix">
					<table>
						...
						<tr class="even">
							...
							<td>
								<span id="this_data_register_huo"></span>
							</td>
							<td>
								<span id="this_data_xiao"></span>
							</td>
							<td>
								<span id="this_data_register_xiao"></span>
							</td>
						</tr>
						<tr class="odd">
							<td>昨日</td>
							...
							<td>
								<span id="to_day_register_huo"></span>
							</td>
							<td>
								<span  id="to_day_xiao"></span>
							</td>
							<td>
								<span id="to_day_register_xiao"></span>
							</td>
						</tr>
						<tr class="even">
							<td>本周</td>
							...
							<td>
								<span id="this_week_register_huo"></span>
							</td>
							<td>
								<span id="this_week_xiao"></span>
							</td>
							<td>
								<span id="this_week_register_xiao"></span>
							</td>
						</tr>
						<tr class="odd">
							<td>上周</td>
							...
							<td>
								<span id="last_week_register_huo"></span>
							</td>
							<td>
								<span id="last_week_xiao"></span>
							</td>
							<td>
								<span id="last_week_register_xiao"></span>
							</td>
						</tr>
						<tr class="even">
							<td >本月</td>
							...
							<td>
								<span id="this_month_register_huo"></span>
							</td>
							<td>
								<span id="this_month_xiao"></span>
							</td>
							<td>
								<span id="this_month_register_xiao"></span>
							</td>
						</tr>
						<tr class="odd">
							<td>上月</td>
							...
							<td>
								<span id="last_month_register_huo"></span>
							</td>
							<td>
								<span id="last_month_xiao" ></span>
							</td>
							<td>
								<span id="last_month_register_xiao"></span>
							</td>
						</tr>
					</table>
				</div>
				<div class="shop-dosage-detail-box">
					<div class="shop-dosage-detail">
						...
						<div class="statistics-public-date">
							<ul>
								...
								<li>
									<span id="statistics_date_1"></span><span>到</span><span id="statistics_date_2"></span>
								</li>
					...
					<div class="shop-dosage-list">
						<table id="statistics_list_id"></table>
					</div>
				</div>
			</div>
		</div>
