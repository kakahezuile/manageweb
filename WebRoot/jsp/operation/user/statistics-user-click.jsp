...
<script src="${pageContext.request.contextPath }/js/user/statistics-user-click.js?version=<%=versionNum %>"></script>
<style type="text/css">
			...
			<div class="shop-dosage-box">
				<div class="shop-dosage">
					<ul>
						...
						<li><a href="${pageContext.request.contextPath }/jsp/operation/user/statistics-user-click.jsp" class="select">用户点击数</a></li>
					</ul>
				</div>
