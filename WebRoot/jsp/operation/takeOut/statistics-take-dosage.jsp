...
<script src="${pageContext.request.contextPath }/js/takeOut/statistics-take-dosage.js"></script>
</head>
<body>
			...
			<div class="right-body">
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-dosage.jsp"  class="select">使用量</a></li>
...
<script src="${pageContext.request.contextPath }/js/takeOut/statistics-take_out.js"></script>
