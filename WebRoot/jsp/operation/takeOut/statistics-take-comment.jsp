...
<script src="${pageContext.request.contextPath }/js/operation.js"></script>
		...
		<script
			src="${pageContext.request.contextPath }/js/takeOut/statistics-take-comment.js"></script>
					...
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-dosage.jsp">使用量</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-turnover.jsp">营业额</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-comment.jsp"
										class="select">投诉与评价</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-time.jsp">服务时间段</a>
								</li>
