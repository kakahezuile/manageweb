...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath }/js/takeOut/statistics-take-turnover.js"></script>
				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
									<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-dosage.jsp" >使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-turnover.jsp" class="select">营业额</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-comment.jsp" >投诉与评价</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-time.jsp" >服务时间段</a></li>
	...
	<script
			src="${pageContext.request.contextPath }/js/takeOut/statistics-take_out.js"></script>
</html>
