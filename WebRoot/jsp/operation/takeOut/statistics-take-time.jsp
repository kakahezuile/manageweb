...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath }/js/takeOut/statistics-take-time.js"></script>
				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							...
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-turnover.jsp" >营业额</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-comment.jsp" >投诉与评价</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-time.jsp" class="select">服务时间段</a></li>
