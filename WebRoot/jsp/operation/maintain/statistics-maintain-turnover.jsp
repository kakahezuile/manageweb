...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath }/js/maintain/statistics-maintain-turnover.js?version=1.1"></script>
				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/maintain/statistics-maintain-dosage.jsp" >使用量</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/maintain/statistics-maintain-turnover.jsp"  class="select">营业额</a></li>
