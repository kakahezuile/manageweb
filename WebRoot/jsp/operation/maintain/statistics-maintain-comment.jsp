...
<script src="${pageContext.request.contextPath }/js/operation.js?version=<%=versionNum %>"></script>
		...
		<script
			src="${pageContext.request.contextPath }/js/maintain/statistics-maintain-comment.js?version=<%=versionNum %>"></script>
...
.loadingbox{
	...
	<body>
		...
		<input type="hidden" id="master_repir_sort_fei" value="5" />
					...
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
								...
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/maintain/statistics-maintain-comment.jsp"
										class="select">投诉与评价</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/maintain/statistics-maintain-time.jsp">服务时间段</a>
								</li>
						...
						<div class="shop-dosage-detail">
							...
							-->
								<a href="javascript:;" class="select" id="data_clik"
									onclick="quickShopData();timeClick('data_clik');">今日</a>
