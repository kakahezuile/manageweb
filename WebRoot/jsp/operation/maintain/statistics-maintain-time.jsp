...
<script src="${pageContext.request.contextPath }/js/operation.js?version=<%=versionNum %>"></script>
		...
		<script
			src="${pageContext.request.contextPath }/js/maintain/statistics-maintain-time.js?version=<%=versionNum %>"></script>
...
.loadingbox{
					...
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/maintain/statistics-maintain-dosage.jsp">使用量</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/maintain/statistics-maintain-turnover.jsp">营业额</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/maintain/statistics-maintain-comment.jsp">投诉与评价</a>
								</li>
								<li>
									<a
										href="${pageContext.request.contextPath }/jsp/operation/maintain/statistics-maintain-time.jsp"
										class="select">服务时间段</a>
								</li>
							</ul>
						</div>
	...
	<script
		src="${pageContext.request.contextPath }/js/maintain/statistics-maintain.js"></script>
