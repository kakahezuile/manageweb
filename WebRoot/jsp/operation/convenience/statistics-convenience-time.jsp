...
<script src="${pageContext.request.contextPath }/js/operation.js?version=<%=versionNum %>"></script>
		...
		<script
			src="${pageContext.request.contextPath }/js/convenience/statistics-convenience-time.js?version=<%=versionNum %>"></script>
				...
				<div class="right-body">
					...
					<div class="shop-dosage">
						<ul>
							...
							<li><a href="${pageContext.request.contextPath }/jsp/operation/convenience/statistics-convenience-time.jsp" class="select">服务时间段</a></li>
