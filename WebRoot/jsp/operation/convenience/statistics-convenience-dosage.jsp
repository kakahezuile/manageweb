...
<script src="${pageContext.request.contextPath }/js/convenience/statistics-convenience-dosage.js?version=<%=versionNum %>"></script>
<style type="text/css">
...
<body>
			...
			<div class="right-body">
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/convenience/statistics-convenience-dosage.jsp" class="select">使用量</a></li>
				...
				<div class="shop-dosage-detail-box">
					...
					<div class="shop-dosage-total">
						<ul>
							<li><a href="javascript:;" onclick="alterMonth('1');" id="date_type_1">前一日</a></li>
							<li><span><b>统计时间</b></span><span id="statistics_date_1">2月20日</span><span>到</span><span id="statistics_date_2">2月26日</span></li>
							<li style="display: none;"><span><b id="dosage_sum">日均点击量</b> </span><span id="avg_day_turnover">450</span></li>
							<li style="display: none;"><span><b id=dosage_avg>日均下单量 </b></span><span id="avg_day_order">450</span></li>
							<li style="display: none;"><span><b>下单占比</b> </span><span id="avg_day_ratio">450</span></li>
							<li><a href="javascript:;" onclick="alterMonth('2');" id="date_type_2">后一日</a></li>
						</ul>
					</div>
	...
	//getClickAmount("2015-5-9","2015-5-31");
	getTryOut();
		   
	
	</script>
</body>
<script src="${pageContext.request.contextPath }/js/convenience/statistics-convenience.js"></script>
