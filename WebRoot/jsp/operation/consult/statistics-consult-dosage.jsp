...
<script src="${pageContext.request.contextPath }/js/consult/statistics-consult-dosage.js?version=<%=versionNum %>"></script>
...
<script src="${pageContext.request.contextPath }/js/consult/statistics-consult.js?version=<%=versionNum %>"></script>
