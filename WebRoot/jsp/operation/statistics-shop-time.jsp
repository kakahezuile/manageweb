...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath }/js/statistics-shop-time.js"></script>
				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							...
							<li><a href="${pageContext.request.contextPath }/jsp/operation/statistics-shop-time.jsp?pages=<%=pages %>" class="select">服务时间段</a></li>
