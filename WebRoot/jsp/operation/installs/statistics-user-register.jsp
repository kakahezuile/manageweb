				...
				<div class="right-body">
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							...
							<!--<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-comment.jsp" >活跃时间段</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-time.jsp" >各版块活跃度</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/operation/takeOut/statistics-take-time.jsp" >交易额</a></li>
