				...
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							...
							<%-- <li><a href="${pageContext.request.contextPath}/jsp/operation/welfare/statistics-buy.jsp">购买详情</a></li>
							<li><a href="${pageContext.request.contextPath}/jsp/operation/welfare/statistics-welfare-detail.jsp">福利详情</a></li> --%>
						</ul>
					</div>
				...
				<div class="shop-dosage-detail-box">
					<div class="shop-dosage-detail">
						...
						<div class="repair-title">
							<a href="javascript:void(0);" onclick="welfare.swithTab(this, 'day');" class="select">日</a>
							<a href="javascript:void(0);" onclick="welfare.swithTab(this, 'week');">周</a>
							<a href="javascript:void(0);" onclick="welfare.swithTab(this, 'month');">月</a>
						</div>
					</div>
					
					<div class="shop-dosage-total" id="tab-day">
						<ul>
							<li><a href="javascript:welfare.stat('day', -1);">上一日</a></li>
							<li><span><b>统计时间</b></span><span id="dayBegin"></span><span>到</span><span id="dayEnd"></span></li>
							<li><a href="javascript:welfare.stat('day', 1);">下一日</a></li>
						</ul>
					</div>
					<div class="shop-dosage-total" id="tab-week" style="display:none">
						<ul>
							<li><a href="javascript:welfare.stat('week', -1);">上一周</a></li>
							<li><span><b>统计时间</b></span><span id="weekBegin"></span><span>到</span><span id="weekEnd"></span></li>
							<li><a href="javascript:welfare.stat('week', 1);">下一周</a></li>
						</ul>
					</div>
					<div class="shop-dosage-total" id="tab-month" style="display:none">
						<ul>
							<li><a href="javascript:welfare.stat('month', -1);">上一月</a></li>
							<li><span><b>统计时间</b></span><span id="monthBegin"></span><span>到</span><span id="monthEnd"></span></li>
							<li><a href="javascript:welfare.stat('month', 1);">下一月</a></li>
						</ul>
					</div>
					
					<div class="shop-dosage-list" id="list-day" >
						<table>
							<thead><tr><th>时间</th><th>点击量</th><th>点击人数</th><th>购买量</th><th>购买占比</th></tr></thead>
