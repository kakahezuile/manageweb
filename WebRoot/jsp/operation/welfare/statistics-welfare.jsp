			...
			<div class="right-body">
				<div class="shop-dosage-box">
					<div class="shop-dosage">
						<ul>
							<li><a href="${pageContext.request.contextPath}/jsp/operation/welfare/statistics-usage.jsp">使用量</a></li>
							<li><a href="${pageContext.request.contextPath}/jsp/operation/welfare/statistics-welfare.jsp" class="select">福利统计</a></li>
						</ul>
					</div>
				...
				<div class="shop-dosage-detail-box" style=" display: none">
					...
					<div class="shop-dosage-total" id="tab-month" style="display:none">
						<ul>
							...
							<li><a href="javascript:welfare.nextMonth();">下一月</a></li>
						</ul>
					</div>
