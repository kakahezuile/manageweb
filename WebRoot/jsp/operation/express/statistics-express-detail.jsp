...
<script src="${pageContext.request.contextPath }/js/operation.js?version=<%=versionNum %>"></script>
		...
		<script
			src="${pageContext.request.contextPath }/js/express/statistics-express-detail.js?version=<%=versionNum %>"></script>
	...
	<body>
		...
		<input type="hidden" id="express_type" />
					...
					<div class="shop-dosage-box">
						<div class="shop-dosage">
							<ul>
								...
								<li>
									<a class="select" href="${pageContext.request.contextPath }/jsp/operation/express/statistics-express-detail.jsp">查看快递记录</a>
								</li>
					...
					<div class="shop-dosage-detail-box">
						...
						<div class="express-list-head">
							<div class="filter-condition">
								...
								<a href="javascript:;" onclick="updateThisSearchType('2')"
									id="express_str_2">未取件</a>
								<a href="javascript:;" onclick="updateThisSearchType('1')"
									id="express_str_1">已取件</a>
							</div>
							<input type="text" id="express_search_fei" />
