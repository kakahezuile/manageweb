...
<script src="${pageContext.request.contextPath }/js/express/statistics-express-dosage.js?version=<%=versionNum %>"></script>
					...
					<div class="shop-dosage">
						<ul>
							<li>
								...
								<li>
									<a href="${pageContext.request.contextPath }/jsp/operation/express/statistics-express-detail.jsp">查看快递记录</a>
								</li>
				...
				<div class="shop-dosage-detail-box">
					...
					<div class="shop-dosage-total">
						<ul>
							...
							<!--
							<li><span><b>日均点击量 </b></span><span id="avg_day_order">450</span></li>
							<li><span><b>增加人数</b> </span><span id="avg_day_ratio">450</span></li>
							-->
...
<script src="${pageContext.request.contextPath }/js/express/statistics-express.js?version=<%=versionNum %>"></script>
