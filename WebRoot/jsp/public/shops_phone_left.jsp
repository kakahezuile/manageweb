	...
	<ul>
		<li>
			<a href="javascript:void(0);" name="shops_phone_1_id"
				onclick="shopsPhoneLeft('shops_phone_1_id'); ">送水</a>
		</li>
		<li>
			<a class="select" href="javascript:void(0);" name="shops_phone_12_id"
				onclick="shopsPhoneLeft('shops_phone_12_id');">快递</a>
		</li>
		<li>
			<a href="javascript:void(0);" name="shops_phone_11_id"
				onclick="shopsPhoneLeft('shops_phone_11_id')">便捷电话</a>
		</li>
		<li>
			<div style="height: 2px; background: #7dd0f8;"></div>
		</li>
		<li>
