	...
	$.ajax({
		...
		var liList = "";
			for ( var i = 0; i < data.length; i++) {
				liList+="<li>";
				liList+="<a onclick=\"\" id=\"community_id_"+data[i].communityId+"\" mark=\"shop\" name=\"shop\" href=\"${pageContext.request.contextPath }/jsp/teamwork/teamwork-left.jsp?modules=3&shopType=2&communityId="+data[i].communityId+"\">"+data[i].communityName+"</a>";
				liList+="</li>";
