			...
			<div class="content clearfix">
				...
				<div class="right-body" style="border:none;">
					<div class="static-detail" id="static_month">
						...
						<table>
							<tr>
								<td colspan="9" class="static-more-title"><div class="static-collect">${list}月交易汇总</div></td>
							</tr>
							<tr>
								<th>交易类型</th>
								<th>点击量</th>
								...
								<tr class="odd">
								<td>${map[list].shoptypeName }</td>
								<td>${map[list].clickNum }</td>
								<td>${map[list].completeCount }</td>
								<td>${map[list].totalPrice }</td>
								<td>${map[list].rate }</td>
								<td>
								<fmt:formatNumber type="number" value="${map[list].totalPrice*map[list].rate*0.01 }" maxFractionDigits="2"/>
								</td>
								<td></td>
								<td></td>
								<td><a href="${pageContext.request.contextPath }/stat/communities/${communityId }/shop/2/getDetail.do?time=${list}">详情</a></td>
							</tr>
						...
						<!--<table>
							<tr>
								<td colspan="9" class="static-more-title"><div class="static-collect">月交易汇总</div></td>
							</tr>
							<tr>
								<th>交易类型</th>
								<th>点击量</th>
