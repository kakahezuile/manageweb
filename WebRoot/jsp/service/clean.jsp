		...
		$.ajax({
					...
					success : function(data) {
						...
						for ( var i = 0; i < data.length; i++) {
							...
							liList += "<a href=\"javascript:;\" class=\"repair-setting\" onclick=\"upClean('"+data[i].shopId+"');\" >&nbsp;</a>";
							...
							liList += "<div class='repair-master-opt'><a href='javascript:void(0);' onclick=masterRepairDatailIdFei('"+data[i].shopId+"','6');>查看保洁记录</a></div></li>";
						...
						repair_overman
								.append("<li><div class='repair-master-add-box'><a href='javascript:void(0);' onclick='addClean();'>"
				   ...
				   <div class="time-chose" id="clean_top_section_time">   
					...
					<div class="repair-content">
						...
						<div class="repair-stat clearfix">
							<div>
								<span id="clean_repairCount_d_m">今日维修次数</span><a href="javascript:;" class="repair-count" id="clean_repairCount">22</a>
							</div>
							<div>
								<span id="clean_todayComplaintsCount_d_m">今日投诉次数</span><a href="javascript:;" class="complain-count" id="clean_todayComplaintsCount">5</a>
								<span id="clean_todayUnComplainsCount_d_m">未解决次数</span><a href="javascript:;" class="nosolve-count" id="clean_todayUnComplainsCount">1</a>
							</div>
							<div>
								<span id="clean_repairMoney_d_m">当日维修金额</span><a href="javascript:;" class="repair-fee" id="clean_repairMoney">209</a>
							</div>
						</div>
						<div class="clearfix repair-detail"><a href="javascript:;" onclick="repairRecordFei('6');">查看详情</a></div>
					</div>
				</div>
