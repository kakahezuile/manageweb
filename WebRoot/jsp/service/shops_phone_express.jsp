...
function addKuaiDiKuai(){
 var sort = document.getElementById("shops_phone_left_id_stor").value;
     ...
     var path = "<%= path%>/api/v1/communities/${communityId}/shops/addKuai?shopName="+shop_name_fei+"&phone="+shop_phone_fei+"&sort="+sort+"&businessStartTime="+business_start_time+"&businessEndTime="+business_end_time;
	...
	function selectShopsPhoneKuai(shopName,num){
		var sort = document.getElementById("shops_phone_left_id_stor").value;
	  var path = "<%= path%>/api/v1/communities/${communityId}/shops?q=12";
				...
				<div class="express-right-body">
					...
					<div class="shops-head" style="padding:30px 0 10px;">
						<div class="express-input-box">
							<span>名称</span>
							<input class="express_phone_name" type="text" id="shop_name_fei_kuai" />
							<span>电话</span>
							<input class="express_phone_number" type="text" id="shop_phone_fei_kuai" />
							<img alt="" src="/images/public/default-image.png"/>
							 <input type="file" id="shops_file" name="shops_file"/>
							<a class="express_logo" href="javascript:;" >上传Logo</a>
						</div>
						<div class="express-open-time">
							<span>营业时间</span>
							<input class="express_phone_place" type="text" id="business_start_time_kuai" />
							<span>到</span>
							<input class="express_phone_place" type="text" id="business_end_time_kuai" />
						</div>
						<div class="shop_phone_add"><a href="javascript:;" onclick="addKuaiDiKuai();">添加</a></div>
					</div>
					<div class="shops-search">
