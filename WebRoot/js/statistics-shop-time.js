...
function getQuickShopTop(sort, startTime, endTime) {
	var path = projectName
			+ "/api/v1/communities/1/shopsOrderHistory/getQuickShopTop?sort="
...
function getTimeQuantumTop(sort, startTime, endTime) {
	var path = projectName
			+ "/api/v1/communities/1/shopsOrderHistory/getTimeQuantumTop?sort="
			+ sort + "&startTime=" + startTime + "&endTime=" + endTime;
	$
			.ajax({
				url : path,
...
function getTimeQuantumList(sort, pageNum, startTime, endTime) {
	...
	var path = projectName
			+ "/api/v1/communities/1/shopsOrderHistory/getTimeQuantumList?pageSize=10&pageNum="
