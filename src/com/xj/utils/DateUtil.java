...
public class DateUtil {
	...
	public static SimpleDateFormat dateformat1 = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm");
	public static SimpleDateFormat dateformatDate = new SimpleDateFormat(
			"yyyy-MM-dd");
	public static SimpleDateFormat dateformatDateTime = new SimpleDateFormat(
			"yy-MM-dd HH:mm");
	public static SimpleDateFormat dateformat2 = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss");
	private static SimpleDateFormat sdf = new SimpleDateFormat();
	// public static TimeZone zone = TimeZone.getTimeZone("GMT+08:00");
	...
	public static void main(String[] args) {
		...
		// String test = date2Constellation(date2Calendar(getDate("19820206",
		// "yyyyMMdd")));
		// System.out.println("星座：" + test);
		// String test1 = date2Zodica(date2Calendar(getDate("19820206",
		// "yyyyMMdd")));
		// System.out.println("生肖：" + test1);
		// Date presetTime = DateUtil.stringToDate("20120320 235959");
		// System.out.println(DateUtil.compareDate(presetTime,
		// DateUtil.getBJDate()));
		// long l=DateUtil.compareDateOfNowDateyyyyMMdd("20141111");
		// System.out.println(l);
		
		String str= DateUtil.hideNowYear("2014-1-16");
