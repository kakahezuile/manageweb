...
public class TestSDKClient {
	...
	public static String softwareSerialNo="6SDK-EMY-6688-KITNN";//软件序列号,请通过亿美销售人员获取
	public static String key="195462";//序列号首次激活时自己设定
	public static String password="195462";// 密码,请通过亿美销售人员获取
	...
	public static void testSendSMS() {
		...
		try {
			int i=SingletonClient.getClient().sendSMS(new String[] {"15010128774"}, "【帮帮】您的验证码是","",5);//带扩展码
	...
	public static void testsSendScheduledSMS() {
		try {
			int i=SingletonClient.getClient().sendScheduledSMSEx(new String[] {"15010128774"}, "定时短信", "20111206160000","GBK");
	...
	public static void testsSendSMSAddMessageId() {
		try {
			int i=SingletonClient.getClient().sendSMSEx(new String[] {"15321215258"}, "验证码很重要说啥都不能告诉别人哦！", "10086", "GBK", 5, 1234567);
			System.out.println("testsSendScheduledSMS====="+i);
		} catch (Exception e) {
			e.printStackTrace();
		}
